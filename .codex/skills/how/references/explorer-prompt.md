...
Start by finding the relevant code. Use the available file-discovery, content-search, and file-reading tools to understand the actual implementation. Don't guess from names — read the code.
